...
- **[arXiv251121] A Scalable NorthPole System with End-to-End Vertical Integration for Low-Latency and Energy-Efficient LLM Inference**
  - **tags:** [mlsys], [llm inference], [NorthPole accelerator, vertical integration, 4-bit quantization, containerized inference, neural inference accelerator]
  ...
  - **institution:** IBM Research
  - **link:** https://arxiv.org/pdf/2511.15950
  - **Simple LLM Summary:** This paper presents a vertically integrated system using 288 NorthPole neural inference accelerator cards to deliver scalable and efficient LLM inference. The system achieves high performance with low latency and energy consumption, supporting multiple model instances simultaneously. The authors conclude this approach is ideal for deploying enterprise AI applications in existing data center environments.

- **[arXiv251121] Optimizing Federated Learning in the Era of LLMs: Message Quantization and Streaming**
  - **tags:** [mlsys], [llm training], [message quantization, container streaming, file streaming, federated learning, large object streaming]
  - **authors:** Ziyue Xu, Zhihong Zhang, Holger R. Roth, Chester Chen, Yan Cheng, Andrew Feng
  - **institution:** Nvidia Corp.
  - **link:** https://arxiv.org/pdf/2511.16450
  - **Simple LLM Summary:** This paper introduces two key techniques - message quantization and container/file streaming - to optimize federated learning for large language models. These methods reduce communication overhead and improve memory management in distributed training scenarios. The proposed enhancements significantly improve the robustness and efficiency of federated learning with LLMs in real-world deployments.

- **[arXiv251121] Digital Agriculture Sandbox for Collaborative Research**
  - **tags:** [mlsys], [others], [federated learning, differential privacy, data analysis, privacy preserving framework]
  - **authors:** Osama Zafar, Rosemarie Santa González, Alfonso Morales, Erman Ayday
  - **institution:** Case Western Reserve University, Georgia Institute of Technology, University of Wisconsin–Madison
  - **link:** https://arxiv.org/pdf/2511.15990
  - **Simple LLM Summary:** The paper presents a Digital Agriculture Sandbox platform that uses federated learning and differential privacy to enable secure collaboration between farmers and researchers. This approach allows analysis of farm data without exposing private information while maintaining research utility. The platform bridges the gap between data privacy and agricultural research, creating a safe environment for data sharing and discovery.

- **[arXiv251121] Fast LLM Post-training via Decoupled and Best-of-N Speculation**
  - **tags:** [mlsys], [post-training], [speculative decoding, dynamic decoupled speculation, Best-of-N speculation]
  ...
  - **link:** https://arxiv.org/pdf/2511.16193
  - **Simple LLM Summary:** This paper introduces SpecActor, a method that accelerates LLM post-training rollout using speculative decoding with dynamic decoupled execution and Best-of-N speculation techniques. These approaches improve GPU computational efficiency and speculation accuracy without requiring extra resources. SpecActor achieves 1.3-1.7× speedup over baseline methods and 1.3-1.5× improvement over naive speculative decoding implementations.

- **[arXiv251121] Secure Autonomous Agent Payments: Verifying Authenticity and Intent in a Trustless Environment**
  - **tags:** [mlsys], [others], [blockchain, decentralized identity, zero-knowledge proofs, TEE-based attestations, verifiable credentials, intent proofs]
  - **authors:** Vivek Acharya
  - **institution:** Not specified
  - **link:** https://arxiv.org/pdf/2511.15712
  - **Simple LLM Summary:** This paper proposes a blockchain-based framework that uses cryptographic techniques including decentralized identity, zero-knowledge proofs, and TEE attestations to verify AI agent authenticity and transaction intent in trustless environments. The hybrid on-chain/off-chain architecture creates an immutable audit trail linking user instructions to payment outcomes. The framework demonstrates strong resistance to impersonation and unauthorized transactions, enabling secure autonomous economic agents with provable trust.

- **[arXiv251121] Optimizing Communication in Byzantine Agreement Protocols with Slim-HBBFT**
  - **tags:** [sys], [distributed systems], [Byzantine agreement, atomic broadcast, asynchronous networks, communication complexity, prioritized provable-broadcast]
  - **authors:** Nasit S Sony, Xianzhong Ding
  - **institution:** University of California, Merced, Lawrence Berkeley National Laboratory
  - **link:** https://arxiv.org/pdf/2511.15957
  - **Simple LLM Summary:** The paper proposes Slim-HBBFT, an atomic broadcast protocol that reduces communication complexity by selecting only a fraction of parties to broadcast requests using a prioritized provable-broadcast mechanism. This approach achieves O(n) improvement in communication complexity while maintaining security through the Asynchronous Common Subset protocol properties. The protocol ensures robust security and reliability while handling Byzantine faults in asynchronous networks.

- **[arXiv251121] Efficient Chromosome Parallelization for Precision Medicine Genomic Workflows**
  - **tags:** [mlsys], [others], [symbolic regression, polynomial regression, Knapsack problem, dynamic scheduling, static scheduling, chromosome parallelization]
  - **authors:** Daniel Mas Montserrat, Ray Verma, Míriam Barrabés, Francisco M. de la Vega, Carlos D. Bustamante, Alexander G. Ioannidis
  - **institution:** Galatea Bio, Stanford University, New York University, University of California, Santa Cruz
  - **link:** https://arxiv.org/pdf/2511.15977
  - **Simple LLM Summary:** This paper proposes adaptive scheduling methods for genomic workflows that use regression models to predict per-chromosome memory requirements and optimize job batching. The approaches include both dynamic and static schedulers that treat task packing as a Knapsack problem to minimize memory overruns. These methods achieve faster execution times and better resource utilization in precision medicine genomic pipelines.

- **[arXiv251121] Pipelined Dense Symmetric Eigenvalue Decomposition on Multi-GPU Architectures**
  - **tags:** [mlsys], [GPU kernels], [pipelined two-stage eigenvalue decomposition, multi-GPU optimization, symmetric eigenvalue problems, tridiagonalization, band reduction, bulge chasing]
  - **authors:** Hansheng Wang, Ruiyi Zhan, Dajun Huang, Xingchen Liu, Qiao Li, Hancong Duan, Dingwen Tao, Guangming Tan, Shaoshuai Zhang
  - **institution:** University of Electronic Science and Technology of China, Chinese Academy of Sciences, Xiamen University
  - **link:** https://arxiv.org/pdf/2511.16174
  - **Simple LLM Summary:** This paper proposes a pipelined two-stage eigenvalue decomposition algorithm with substantial optimizations for multi-GPU architectures. The method achieves significant performance improvements over existing libraries like cuSOLVERMp and MAGMA, delivering mean speedups of 5.74× and 6.59× on an 8×A100 platform with better scalability.

- **[arXiv251121] Can Asymmetric Tile Buffering Be Beneficial?**
  - **tags:** [mlsys], [GPU kernels], [asymmetric tile buffering, tiling strategies, performance modeling, arithmetic intensity, kernel switching overhead]
  ...
  - **institution:** UCLA, UIUC, EPFL, UT Austin, AMD
  - **link:** https://arxiv.org/pdf/2511.16041
  - **Simple LLM Summary:** This paper introduces asymmetric tile buffering (ATB), a technique that decouples input and output tile dimensions in GEMM operations to reduce buffer pressure and increase arithmetic intensity. The authors develop a performance model that balances ATB's benefits against kernel switching overheads and demonstrate its effectiveness on AMD's XDNA2 AI Engine, achieving up to 4.54× speedup and setting new performance records for mixed-precision GEMM.

- **[arXiv251121] Mitigating Shared Storage Congestion Using Control Theory**
  - **tags:** [sys], [HPC storage optimization], [Control Theory, I/O rate regulation, runtime system load metrics, congestion mitigation]
  ...
  - **institution:** Qarnot Computing, University of Lille, Inria, CNRS, Centrale Lille, University of Grenoble Alpes, CNRS, Grenoble INP
  - **link:** https://arxiv.org/pdf/2511.16177
  - **Simple LLM Summary:** This paper proposes a self-adaptive approach using Control Theory to dynamically regulate client-side I/O rates in shared HPC environments. The method leverages runtime system load metrics to reduce storage congestion and improve performance stability. Experimental results show the approach effectively mitigates I/O congestion, reducing total runtime by up to 20% while lowering tail latency.

- **[arXiv251121] Distributed MIS Algorithms for Rational Agents using Games**
  - **tags:** [sys], [distributed algorithms], [maximal independent set, rational agents, game theory, symmetry breaking, trembling-hand perfect equilibrium]
  - **authors:** Nithin Salevemula, Shreyas Pai
  - **institution:** Indian Institute of Technology Madras
  - **link:** https://arxiv.org/pdf/2511.16533
  - **Simple LLM Summary:** This paper proposes two distributed algorithms for computing Maximal Independent Sets in networks where nodes are rational agents with payoff-dependent utilities. The algorithms use pairwise interactions between neighboring nodes as simple games to generate randomness and break symmetry while ensuring no unilateral deviations can improve expected utility. The approach guarantees correct MIS computation with positive participation probability for all nodes and O(log n) round complexity under mild assumptions.

- **[arXiv251121] A Fast Relax-and-Round Approach to Unit Commitment for Data Center Own Generation**
  - **tags:** [sys], [power systems optimization], [mixed integer programming, relax and round, unit commitment, continuous solvers, GPU parallel computation]
  - **authors:** Shaked Regev, Eve Tsybina, Slaven Peles
  - **institution:** UT-Battelle, LLC (Oak Ridge National Laboratory)
  - **link:** https://arxiv.org/pdf/2511.16420
  - **Simple LLM Summary:** The paper proposes a relax-and-round approach for unit commitment that allows generators to be fractionally on, enabling continuous solvers before rounding to feasible solutions. This method reduces solution time from 10 hours to less than a second for a 276-unit system with minor accuracy loss. The approach scales to tens of thousands of generators and is GPU-compatible, making it suitable for large-scale power system applications.

- **[arXiv251121] Taming the Long-Tail: Efficient Reasoning RL Training with Adaptive Drafter**
  - **tags:** [mlsys], [llm training], [speculative decoding, adaptive drafter, CUDAGraphs, reinforcement learning]
  - **authors:** Qinghao Hu, Shang Yang, Junxian Guo, Xiaozhe Yao, Yujun Lin, Yuxian Gu, Han Cai, Chuang Gan, Ana Klimovic, Song Han
  - **institution:** MIT, NVIDIA, ETH Zurich, MIT-IBM Watson AI Lab, UMass Amherst
  - **link:** https://arxiv.org/pdf/2511.16665
  - **Simple LLM Summary:** The paper proposes TLT, a system that accelerates reasoning RL training for LLMs using adaptive speculative decoding with two key components: an Adaptive Drafter trained during idle GPU time and an Adaptive Rollout Engine with optimized CUDAGraphs. This approach addresses the long-tail distribution problem in response generation during RL training. Evaluations show TLT achieves over 1.7x speedup while preserving model accuracy and producing a high-quality draft model as a byproduct.


**cs.AI/cs.LG contains "reinforcement learning" total: 22**
- [arXiv251121] Extending Test-Time Scaling: A 3D Perspective with Context, Batch, and Turn [link](https://arxiv.org/pdf/2511.15738)
- [arXiv251121] OpenMMReasoner: Pushing the Frontiers for Multimodal Reasoning with an Open and General Recipe [link](https://arxiv.org/pdf/2511.16334)
- [arXiv251121] Optimizing Operation Recipes with Reinforcement Learning for Safe and Interpretable Control of Chemical Processes [link](https://arxiv.org/pdf/2511.16297)
- [arXiv251121] KRAL: Knowledge and Reasoning Augmented Learning for LLM-assisted Clinical Antimicrobial Therapy [link](https://arxiv.org/pdf/2511.15974)
- [arXiv251121] Revisiting Fairness-aware Interactive Recommendation: Item Lifecycle as a Control Knob [link](https://arxiv.org/pdf/2511.16248)
- [arXiv251121] Pass@k Metric for RLVR: A Diagnostic Tool of Exploration, But Not an Objective [link](https://arxiv.org/pdf/2511.16231)
- [arXiv251121] Agent0: Unleashing Self-Evolving Agents from Zero Data via Tool-Integrated Reasoning [link](https://arxiv.org/pdf/2511.16043)
- [arXiv251121] MACIE: Multi-Agent Causal Intelligence Explainer for Collective Behavior Understanding [link](https://arxiv.org/pdf/2511.15716)
- [arXiv251121] A Mathematical Framework for Custom Reward Functions in Job Application Evaluation using Reinforcement Learning [link](https://arxiv.org/pdf/2511.16073)
- [arXiv251121] Thinking, Faithful and Stable: Mitigating Hallucinations in LLMs [link](https://arxiv.org/pdf/2511.15921)
- [arXiv251121] HGCN2SP: Hierarchical Graph Convolutional Network for Two-Stage Stochastic Programming [link](https://arxiv.org/pdf/2511.16027)
- [arXiv251121] A Hybrid Proactive And Predictive Framework For Edge Cloud Resource Management [link](https://arxiv.org/pdf/2511.16075)
- [arXiv251121] SkyRL-Agent: Efficient RL Training for Multi-turn LLM Agent [link](https://arxiv.org/pdf/2511.16108)
- [arXiv251121] A Comparison Between Decision Transformers and Traditional Offline Reinforcement Learning Algorithms [link](https://arxiv.org/pdf/2511.16475)
- [arXiv251121] Limitations of Scalarisation in MORL: A Comparative Study in Discrete Environments [link](https://arxiv.org/pdf/2511.16476)
- [arXiv251121] Large Language Model-Based Reward Design for Deep Reinforcement Learning-Driven Autonomous Cyber Defense [link](https://arxiv.org/pdf/2511.16483)
- [arXiv251121] Green Resilience of Cyber-Physical Systems: Doctoral Dissertation [link](https://arxiv.org/pdf/2511.16593)
- [arXiv251121] Bridging VLMs and Embodied Intelligence with Deliberate Practice Policy Optimization [link](https://arxiv.org/pdf/2511.16602)
- [arXiv251121] Stabilizing Policy Gradient Methods via Reward Profiling [link](https://arxiv.org/pdf/2511.16629)
- [arXiv251121] Dexterity from Smart Lenses: Multi-Fingered Robot Manipulation with In-the-Wild Human Demonstrations [link](https://arxiv.org/pdf/2511.16661)
- [arXiv251121] Thinking-while-Generating: Interleaving Textual Reasoning throughout Visual Generation [link](https://arxiv.org/pdf/2511.16671)
- [arXiv251121] A Primer on Quantum Machine Learning [link](https://arxiv.org/pdf/2511.15969)

**cs.AI/cs.LG contains "accelerate" total: 13**
- [arXiv251121] From Performance to Understanding: A Vision for Explainable Automated Algorithm Design [link](https://arxiv.org/pdf/2511.16201)
- [arXiv251121] Early science acceleration experiments with GPT-5 [link](https://arxiv.org/pdf/2511.16072)
- [arXiv251121] The Future of Food: How Artificial Intelligence is Transforming Food Manufacturing [link](https://arxiv.org/pdf/2511.15728)
- [arXiv251121] AccelOpt: A Self-Improving LLM Agentic System for AI Accelerator Kernel Optimization [link](https://arxiv.org/pdf/2511.15915)
- [arXiv251121] HGCN2SP: Hierarchical Graph Convolutional Network for Two-Stage Stochastic Programming [link](https://arxiv.org/pdf/2511.16027)
- [arXiv251121] VLA-Pruner: Temporal-Aware Dual-Level Visual Token Pruning for Efficient Vision-Language-Action Inference [link](https://arxiv.org/pdf/2511.16449)
- [arXiv251121] Multi-Agent LLM Orchestration Achieves Deterministic, High-Quality Decision Support for Incident Response [link](https://arxiv.org/pdf/2511.15755)
- [arXiv251121] LLM4EO: Large Language Model for Evolutionary Optimization in Flexible Job Shop Scheduling [link](https://arxiv.org/pdf/2511.16485)
- [arXiv251121] Supervised Contrastive Learning for Few-Shot AI-Generated Image Detection and Attribution [link](https://arxiv.org/pdf/2511.16541)
- [arXiv251121] An Exterior-Embedding Neural Operator Framework for Preserving Conservation Laws [link](https://arxiv.org/pdf/2511.16573)
- [arXiv251121] ECPv2: Fast, Efficient, and Scalable Global Optimization of Lipschitz Functions [link](https://arxiv.org/pdf/2511.16575)
- [arXiv251121] Almost Sure Convergence Analysis of Differentially Private Stochastic Gradient Methods [link](https://arxiv.org/pdf/2511.16587)
- [arXiv251121] gfnx: Fast and Scalable Library for Generative Flow Networks in JAX [link](https://arxiv.org/pdf/2511.16592)
