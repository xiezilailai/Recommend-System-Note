...
- **[arXiv251219] Optimizing Agentic Language Model Inference via Speculative Tool Calls**
  - **tags:** [mlsys], [llm inference], [speculative tool calls, tool cache, prefix-caching, vLLM]
  ...
  - **Simple LLM Summary:** This paper introduces systems optimizations for language model inference by speculating future tool calls and keeping sequences resident in the inference engine to reduce overhead. These methods lead to significant throughput improvements of several hundred tokens per second for agentic LMs. The authors also propose a "tool cache" API to facilitate adoption of these optimizations.

- **[arXiv251219] Cold-Start Anti-Patterns and Refactorings in Serverless Systems: An Empirical Study**
  - **tags:** [sys], [serverless computing], [SCABENCH, INITSCOPE, static analysis, lazy loading, cold-start anti-patterns]
  - **authors:** Syed Salauddin Mohammad Tariq, Foyzul Hassan, Amiangshu Bosu, Probir Roy
  - **institution:** University of Michigan–Dearborn, Wayne State University
  - **link:** https://arxiv.org/pdf/2512.16066
  - **Simple LLM Summary:** This paper studies cold-start latency in serverless systems as a developer-visible design problem, deriving anti-patterns from issue reports and introducing the INITSCOPE analysis framework and SCABENCH benchmark. The results show that INITSCOPE significantly improves localization accuracy and reduces diagnostic effort compared to prior tools, advancing evidence-driven practices for cold-start mitigation.

- **[arXiv251219] LOOPRAG: Enhancing Loop Transformation Optimization with Retrieval-Augmented Large Language Models**
  - **tags:** [mlsys], [llm inference], [retrieval-augmented generation, loop transformation, static control part, feedback-based iterative mechanism, equivalence testing]
  ...
  - **Simple LLM Summary:** The paper proposes LOOPRAG, a retrieval-augmented generation framework that uses loop-aware retrieval and feedback from compilation/testing to guide LLMs in performing effective loop transformations. The method demonstrates significant performance improvements, achieving speedups over both traditional compilers and base LLMs on standard benchmark suites.

- **[arXiv251219] An Online Fragmentation-Aware Scheduler for Managing GPU-Sharing Workloads on Multi-Instance GPUs**
  - **tags:** [mlsys], [cluster infrastructure], [Multi-Instance GPU (MIG), online scheduling, fragmentation-aware, load balancing, dynamic partitioning, job migration]
  - **authors:** Hsu-Tzu Ting, Jerry Chou, Ming-Hung Chen, I-Hsin Chung
  - **institution:** National Tsing Hua University, IBM T. J. Watson Research Center
  - **link:** https://arxiv.org/pdf/2512.16099
  - **Simple LLM Summary:** The paper proposes an online scheduling framework for Multi-Instance GPUs (MIG) that integrates conditional load balancing, dynamic partitioning, and job migration to minimize resource contention and combat GPU fragmentation. This approach dynamically adapts job placement and reorganizes GPU allocations. Experimental results show the method significantly improves system efficiency, reducing makespan by up to 35%.

- **[arXiv251219] LOG.io: Unified Rollback Recovery and Data Lineage Capture for Distributed Data Pipelines**
  - **tags:** [sys], [fault-tolerance], [rollback recovery, data lineage, log-based protocol, asynchronous barrier snapshotting, data parallelization]
  - **authors:** Eric Simon, Renato B. Hoffmann, Lucas Alf, Dalvan Griebler
  - **institution:** SAP Labs, Pontifical Catholic University of Rio Grande do Sul
  - **link:** https://arxiv.org/pdf/2512.16038
  - **Simple LLM Summary:** This paper introduces LOG.io, a log-based protocol for unified rollback recovery and fine-grained data lineage capture in distributed data pipelines. It supports non-deterministic operators and dynamic scaling, and its performance evaluation shows it can match or outperform the Asynchronous Barrier Snapshotting protocol, especially during recovery in the presence of stragglers, with minimal overhead for lineage capture.

- **[arXiv251219] Private Virtual Tree Networks for Secure Multi-Tenant Environments Based on the VIRGO Overlay Network**
  - **tags:** [sys], [distributed systems security], [VIRGO overlay, public key cryptography, delegation certificates, hierarchical access control]
  - **authors:** Lican Huang
  - **institution:** Hangzhou Domain Zones Technology Co., Ltd.
  - **link:** https://arxiv.org/pdf/2512.15915
  - **Simple LLM Summary:** This paper proposes Private Virtual Tree Networks (PVTNs), a cryptographic extension to the VIRGO hierarchical overlay network. PVTNs use public-key encryption and manager-signed delegation certificates to create secure, private, and non-enumerable virtual trees that mirror organizational hierarchies. The work demonstrates that this approach achieves scalable, dynamic management and strong security without relying on a global public key infrastructure.

- **[arXiv251219] SHARe-KAN: Holographic Vector Quantization for Memory-Bound Inference**
  - **tags:** [mlsys], [llm inference], [vector quantization, memory planning, cache optimization, spline networks]
  - **authors:** Jeff Smith
  - **institution:** 2nd Set AI
  - **link:** https://arxiv.org/pdf/2512.15742
  - **Simple LLM Summary:** This paper introduces SHARe-KAN, a framework that uses Gain-Shape-Bias Vector Quantization to compress Kolmogorov-Arnold Networks (KANs) by exploiting functional redundancy while preserving their dense, holographic topology. Combined with a hardware-aware compiler (LUTHAM) for static memory planning, it drastically reduces runtime memory by 88x and maintains baseline accuracy, effectively decoupling the workload from DRAM bandwidth constraints for memory-bound inference.
...
- **[arXiv251219] Staggered Batch Scheduling: Co-optimizing Time-to-First-Token and Throughput for High-Efficiency LLM Inference**
  - **tags:** [mlsys], [llm inference], [staggered batch scheduling, load-aware global allocation, DP+EP, data parallelism, expert parallelism, time-to-first-token]
  ...
  - **Simple LLM Summary:** The paper proposes Staggered Batch Scheduling (SBS), a method that buffers incoming requests to form optimal batches before dispatching them to a DP+EP inference cluster, eliminating internal queuing. It also introduces a Load-Aware Global Allocation strategy to balance computational load. The system reduces Time-to-First-Token by 30-40% and improves throughput by 15-20% compared to immediate scheduling baselines.

- **[arXiv251219] MultiPath Transfer Engine: Breaking GPU and Host-Memory Bandwidth Bottlenecks in LLM Services**
  - **tags:** [mlsys], [llm inference], [Multipath Memory Access (MMA), PCIe, NVLink, dynamic library injection, time-to-first-token (TTFT), model switching]
  - **authors:** Lingfeng Tang, Daoping Zhang, Junjie Chen, Peihao Huang, Feng Jin, Chengguang Xu, Yuxin Chen, Feiqiang Sun, Guo Chen
  - **institution:** Hunan University, Tencent
  - **link:** https://arxiv.org/pdf/2512.16056
  - **Simple LLM Summary:** The paper proposes Multipath Memory Access (MMA), a scheme that enables efficient multipath data transfer between GPU and host memory by utilizing multiple intra-server paths like PCIe and NVLink. It achieves a 4.62x bandwidth improvement, significantly reducing time-to-first-token and model-switching latency for LLM serving without requiring code modifications.

- **[arXiv251219] Twinning for Space-Air-Ground-Sea Integrated Networks: Beyond Conventional Digital Twin Towards Goal-Oriented Semantic Twin**
  - **tags:** [mlsys], [others], [goal-oriented semantic twin, digital twin, semantic technologies, knowledge-based semantics, data-driven semantics, perception-communication-computing-actuation]
  - **authors:** Yifei Qiu, Tianle Liao, Xin Jin, Shaohua Wu, Dusit Niyato, Qinyu Zhang
  - **institution:** Harbin Institute of Technology (Shenzhen), Nanyang Technological University, Pengcheng Laboratory
  - **link:** https://arxiv.org/pdf/2512.16058
  - **Simple LLM Summary:** This paper proposes a Goal-Oriented Semantic Twin (GOST) framework for Space-Air-Ground-Sea Integrated Networks, prioritizing task-specific utility over high-fidelity physical mirroring to overcome the computational and synchronization limitations of conventional Digital Twins. It concludes that GOST, built on semantic technologies and goal-oriented principles, significantly outperforms traditional approaches in tasks like collaborative tracking, establishing it as a transformative paradigm for future network development.

- **[arXiv251219] Kascade: A Practical Sparse Attention Method for Long-Context LLM Inference**
  - **tags:** [mlsys], [llm inference], [sparse attention, dynamic programming, top-k selection, head-aware, FlashAttention]
  ...
  - **Simple LLM Summary:** Kascade is a training-free sparse attention method for long-context LLM inference that computes exact Top-k indices in selected anchor layers and reuses them in intermediate layers, selected via a dynamic-programming algorithm. It achieves significant speedups (up to 4.1x in decode, 2.2x in prefill) over dense attention baselines while closely matching accuracy on long-context benchmarks.

- **[arXiv251219] Efficient Bitcoin Meta-Protocol Transaction and Data Discovery Through nLockTime Field Repurposing**
  - **tags:** [sys], [blockchain protocol], [nLockTime, OP_RETURN, witness data, transaction discovery, metadata header]
  - **authors:** Nikodem Tomczak
  - **institution:** Thulge Labs
  - **link:** https://arxiv.org/pdf/2512.16683
  - **Simple LLM Summary:** The paper introduces the Lockchain Protocol, which repurposes Bitcoin's nLockTime field as a compact metadata header to enable efficient transaction discovery without additional block space. This allows indexers to filter transactions quickly by examining a fixed-size header before inspecting larger payloads. The protocol improves scalability and reduces centralization risks in Bitcoin meta-protocols without introducing new storage mechanisms.
...
- **[arXiv251219] Coordinated Anti-Jamming Resilience in Swarm Networks via Multi-Agent Reinforcement Learning**
  ...
  - **Simple LLM Summary:** This paper proposes a multi-agent reinforcement learning framework based on the QMIX algorithm to coordinate anti-jamming actions in swarm networks. The method enables agents to jointly select transmission channels and power levels to counter an adaptive reactive jammer. Simulation results show that QMIX achieves near-optimal performance with higher throughput and lower jamming incidence compared to baseline methods.

- **[arXiv251219] Lotus: Optimizing Disaggregated Transactions with Disaggregated Locks**
  - **tags:** [sys], [distributed transaction systems], [lock disaggregation, application-aware lock management, lock-first transaction protocol, lock-rebuild-free recovery, RDMA, disaggregated memory]
  - **authors:** Zhisheng Hu, Pengfei Zuo, Junliang Hu, Yizou Chen, Yingjia Wang, Ming-Chang Yang
  - **institution:** The Chinese University of Hong Kong, Huawei
  - **link:** https://arxiv.org/pdf/2512.16136
  - **Simple LLM Summary:** This paper presents Lotus, a distributed transaction system for disaggregated memory that moves locks from memory nodes to compute nodes to eliminate the RDMA NIC bottleneck. It introduces a lock-first transaction protocol and a lightweight recovery mechanism to manage locks efficiently and handle failures. The system improves transaction throughput by up to 2.1x and reduces latency by up to 49.4% compared to state-of-the-art systems.

- **[arXiv251219] Efficient CPU-GPU Collaborative Inference for MoE-based LLMs on Memory-Limited Systems**
  - **tags:** [mlsys], [llm inference], [CPU-GPU collaborative inference, expert caching, offloading, MoE, memory-limited systems]
  - **authors:** En-Ming Huang, Li-Shang Lin, Chun-Yi Lee
  - **institution:** National Taiwan University, National Tsing Hua University
  - **link:** https://arxiv.org/pdf/2512.16473
  - **Simple LLM Summary:** This paper introduces a CPU-GPU collaborative inference framework for MoE-based LLMs that uses an expert caching mechanism on the GPU to reduce data transfer latency. It offloads computations for cache misses to the CPU, leveraging multithreading, to improve inference performance on memory-limited consumer hardware. The evaluation shows the framework achieves performance improvements by maximizing hardware utilization.

- **[arXiv251219] FlexKV: Flexible Index Offloading for Memory-Disaggregated Key-Value Store**
  - **tags:** [sys], [distributed systems], [disaggregated memory, key-value store, index offloading, rank-aware hotness detection, two-level CN memory optimization, RPC-aggregated cache management]
  - **authors:** Zhisheng Hu, Jiacheng Shen, Ming-Chang Yang
  - **institution:** The Chinese University of Hong Kong, Duke Kunshan University
  - **link:** https://arxiv.org/pdf/2512.16148
  - **Simple LLM Summary:** FlexKV is a memory-disaggregated key-value store that dynamically offloads indexes to compute nodes to accelerate processing and improve cache efficiency. It addresses challenges like load imbalance and cache coherence with a rank-aware hotness detection algorithm, a two-level memory optimization scheme, and an RPC-aggregated cache mechanism. The system demonstrates significant performance improvements, increasing throughput by up to 2.94x and reducing latency by up to 85.2% compared to state-of-the-art alternatives.

- **[arXiv251219] Training Together, Diagnosing Better: Federated Learning for Collagen VI-Related Dystrophies**
  - **tags:** [mlsys], [others], [federated learning, collagen VI-related dystrophies, immunofluorescence microscopy, classification, privacy-preserving machine learning]
  ...
  - **institution:** National Institutes of Health, University College London, Sherpa.ai
  - **link:** https://arxiv.org/pdf/2512.16876
  - **Simple LLM Summary:** The paper employs Federated Learning (FL) via the Sherpa.ai platform to collaboratively train a diagnostic model on decentralized collagen VI immunofluorescence images from multiple international institutions while keeping patient data local. This approach achieved an F1-score of 0.82 for classifying disease mechanisms, outperforming models trained on single-institution data. The results demonstrate that FL substantially improves diagnostic accuracy and model generalizability for rare diseases while addressing data privacy and regulatory challenges.

- **[arXiv251219] Delay-Aware Multi-Stage Edge Server Upgrade with Budget Constraint**
  - **tags:** [sys], [network planning], [Mixed Integer Linear Programming, heuristic algorithm, task offloading, edge server upgrade, budget constraint]
  ...
  - **Simple LLM Summary:** This paper proposes a Multi-stage Edge Server Upgrade (M-ESU) framework for network planning, which uses a Mixed Integer Linear Programming (MILP) model for optimal solutions in small networks and an efficient heuristic algorithm (M-ESU/H) for large-scale networks. The main conclusion is that the heuristic algorithm performs close to optimal (within 1.25%) and significantly faster, and it yields up to 21.57% improvement in task satisfaction compared to alternative approaches under budget and demand growth constraints.

- **[arXiv251219] AI4EOSC: a Federated Cloud Platform for Artificial Intelligence in Scientific Research**
  - **tags:** [mlsys], [cluster infrastructure], [federated cloud platform, reproducible deployments, machine learning lifecycle, interactive development environments, GPU resources, federated learning, experiment tracking, model traceability]
  ...
  - **Simple LLM Summary:** This paper introduces AI4EOSC, a federated cloud platform designed to support the full machine learning lifecycle for scientific research. It provides integrated access to distributed e-infrastructures, offering services for model development, training, and deployment with a focus on reproducibility and traceability. The platform aims to lower adoption barriers and facilitate collaborative AI research across scientific communities.


**cs.AI/cs.LG contains "reinforcement learning" total: 23**
- [arXiv251219] Dynamic Rank Reinforcement Learning for Adaptive Low-Rank Multi-Head Self Attention in Large Language Models [link](https://arxiv.org/pdf/2512.15973)
- [arXiv251219] DSO: Direct Steering Optimization for Bias Mitigation [link](https://arxiv.org/pdf/2512.15926)
- [arXiv251219] Techno-economic optimization of a heat-pipe microreactor, part I: theory and cost optimization [link](https://arxiv.org/pdf/2512.16032)
- [arXiv251219] Small Language Models for Efficient Agentic Tool Calling: Outperforming Large Models with Targeted Fine-tuning [link](https://arxiv.org/pdf/2512.15943)
- [arXiv251219] INTELLECT-3: Technical Report [link](https://arxiv.org/pdf/2512.16144)
- [arXiv251219] MRG-R1: Reinforcement Learning for Clinically Aligned Medical Report Generation [link](https://arxiv.org/pdf/2512.16145)
- [arXiv251219] Hypernetworks That Evolve Themselves [link](https://arxiv.org/pdf/2512.16406)
- [arXiv251219] NDRL: Cotton Irrigation and Nitrogen Application with Nested Dual-Agent Reinforcement Learning [link](https://arxiv.org/pdf/2512.16408)
- [arXiv251219] StarCraft+: Benchmarking Multi-agent Algorithms in Adversary Paradigm [link](https://arxiv.org/pdf/2512.16444)
- [arXiv251219] Guiding Perception-Reasoning Closer to Human in Blind Image Quality Assessment [link](https://arxiv.org/pdf/2512.16484)
- [arXiv251219] ParamExplorer: A framework for exploring parameters in generative art [link](https://arxiv.org/pdf/2512.16529)
- [arXiv251219] Stackelberg Learning from Human Feedback: Preference Optimization as a Sequential Game [link](https://arxiv.org/pdf/2512.16626)
- [arXiv251219] Implementing a Sharia Chatbot as a Consultation Medium for Questions About Islam [link](https://arxiv.org/pdf/2512.16644)
- [arXiv251219] Olaf: Bringing an Animated Character to Life in the Physical World [link](https://arxiv.org/pdf/2512.16705)
- [arXiv251219] Meta-RL Induces Exploration in Language Agents [link](https://arxiv.org/pdf/2512.16848)
- [arXiv251219] ReinforceGen: Hybrid Skill Policies with Automated Data Generation and Reinforcement Learning [link](https://arxiv.org/pdf/2512.16861)
- [arXiv251219] Posterior Behavioral Cloning: Pretraining BC Policies for Efficient RL Finetuning [link](https://arxiv.org/pdf/2512.16911)
- [arXiv251219] Exploration v.s. Exploitation: Rethinking RLVR through Clipping, Entropy, and Spurious Reward [link](https://arxiv.org/pdf/2512.16912)
- [arXiv251219] Generative Adversarial Reasoner: Enhancing LLM Reasoning with Adversarial Reinforcement Learning [link](https://arxiv.org/pdf/2512.16917)
- [arXiv251219] Differences That Matter: Auditing Models for Capability Gap Discovery and Rectification [link](https://arxiv.org/pdf/2512.16921)
- [arXiv251219] The Red Queen's Trap: Limits of Deep Evolution in High-Frequency Trading [link](https://arxiv.org/pdf/2512.15732)
- [arXiv251219] Deep Reinforcement Learning Optimization for Uncertain Nonlinear Systems via Event-Triggered Robust Adaptive Dynamic Programming [link](https://arxiv.org/pdf/2512.15735)
- [arXiv251219] Non-Asymptotic Global Convergence of PPO-Clip [link](https://arxiv.org/pdf/2512.16565)

**cs.AI/cs.LG contains "accelerate" total: 13**
- [arXiv251219] Introduction to Symbolic Regression in the Physical Sciences [link](https://arxiv.org/pdf/2512.15920)
- [arXiv251219] TS-DP: Reinforcement Speculative Decoding For Temporal Adaptive Diffusion Policy Acceleration [link](https://arxiv.org/pdf/2512.15773)
- [arXiv251219] Surrogate Neural Architecture Codesign Package (SNAC-Pack) [link](https://arxiv.org/pdf/2512.15998)
- [arXiv251219] TurboDiffusion: Accelerating Video Diffusion Models by 100-200 Times [link](https://arxiv.org/pdf/2512.16093)
- [arXiv251219] Science Consultant Agent [link](https://arxiv.org/pdf/2512.16171)
- [arXiv251219] Pretrained Battery Transformer (PBT): A battery life prediction foundation model [link](https://arxiv.org/pdf/2512.16334)
- [arXiv251219] Multi-Fidelity Delayed Acceptance: hierarchical MCMC sampling for Bayesian inverse problems combining multiple solvers through deep neural networks [link](https://arxiv.org/pdf/2512.16430)
- [arXiv251219] XTC, A Research Platform for Optimizing AI Workload Operators [link](https://arxiv.org/pdf/2512.16512)
- [arXiv251219] Abacus: Self-Supervised Event Counting-Aligned Distributional Pretraining for Sequential User Modeling [link](https://arxiv.org/pdf/2512.16581)
- [arXiv251219] LLMCache: Layer-Wise Caching Strategies for Accelerated Reuse in Transformer Inference [link](https://arxiv.org/pdf/2512.16843)
- [arXiv251219] TinyMyo: a Tiny Foundation Model for Flexible EMG Signal Processing at the Edge [link](https://arxiv.org/pdf/2512.15729)
- [arXiv251219] Bayesian Modeling for Uncertainty Management in Financial Risk Forecasting and Compliance [link](https://arxiv.org/pdf/2512.15739)
- [arXiv251219] Riemannian Stochastic Interpolants for Amorphous Particle Systems [link](https://arxiv.org/pdf/2512.16607)
