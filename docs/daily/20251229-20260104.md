...
- **[arXiv260101] PackKV: Reducing KV Cache Memory Footprint through LLM-Aware Lossy Compression**
  - **tags:** [mlsys], [llm inference], [lossy compression, KV cache, memory footprint, matrix-vector multiplication, GPU]
  ...
  - **Simple LLM Summary:** This paper introduces PackKV, a framework that reduces the memory footprint of the key-value (KV) cache in large language models through LLM-aware lossy compression. It achieves significantly higher memory reduction and execution throughput compared to state-of-the-art quantization methods while maintaining accuracy.

- **[arXiv260101] Data Heterogeneity-Aware Client Selection for Federated Learning in Wireless Networks**
  - **tags:** [mlsys], [others], [client selection, resource allocation, convex optimization, data heterogeneity, generalization error]
  ...
  - **Simple LLM Summary:** This paper proposes a joint client selection and resource allocation (CSRA) approach for federated learning in wireless networks, which uses convex optimization techniques to minimize latency and energy while controlling generalization error. The method accounts for data heterogeneity among clients. Simulation results show it achieves higher test accuracy with lower latency and energy consumption compared to baseline methods.

- **[arXiv260101] Zero-Trust Agentic Federated Learning for Secure IIoT Defense Systems**
  - **tags:** [mlsys], [fault-tolerance], [federated learning, zero-trust architecture, TPM attestation, SHAP-weighted aggregation, Byzantine detection, adversarial training]
  - **authors:** Samaresh Kumar Singh, Joyjit Roy, Martin So
  - **institution:** Independent Researchers
  - **link:** https://arxiv.org/pdf/2512.23809
  - **Simple LLM Summary:** The paper proposes a Zero-Trust Agentic Federated Learning (ZTA-FL) framework for secure Industrial IoT defense, combining TPM-based attestation, a SHAP-weighted aggregation algorithm for Byzantine detection, and on-device adversarial training. It demonstrates high detection accuracy and robustness against poisoning attacks while reducing communication overhead.

- **[arXiv260101] A Granular Grassmannian Clustering Framework via the Schubert Variety of Best Fit**
  - **tags:** [ai], [subspace clustering], [Schubert Variety of Best Fit, Linde-Buzo-Grey, Grassmann manifold, principal angles]
  - **authors:** Karim Salta, Michael Kirby, Chris Peterson
  - **institution:** Colorado State University
  - **link:** https://arxiv.org/pdf/2512.23766
  - **Simple LLM Summary:** This paper introduces a subspace clustering algorithm that uses a trainable prototype called a Schubert Variety of Best Fit (SVBF) instead of traditional subspace means. The method is integrated into the Linde-Buzo-Grey pipeline, and it demonstrates improved cluster purity on synthetic, image, spectral, and video action data while preserving mathematical structure for analysis.

- **[arXiv260101] Squeezing Edge Performance: A Sensitivity-Aware Container Management for Heterogeneous Tasks**
  - **tags:** [sys], [edge computing], [container-based resource management, mixed-integer nonlinear programming, convex optimization, greedy refinement, queueing-based delay formulation]
  - **authors:** Yongmin Zhang, Pengyu Huang, Mingyi Dong, Jing Yao
  - **institution:** Central South University
  - **link:** https://arxiv.org/pdf/2512.23952
  - **Simple LLM Summary:** This paper proposes a two-stage container-based resource management scheme (CRMS) that uses a measurement-derived nonlinear model and convex optimization to minimize latency and power consumption on a single edge server. The method decomposes an NP-hard MINLP problem into tractable subproblems. Simulation results show CRMS reduces latency by over 14% and improves energy efficiency compared to baseline approaches.

- **[arXiv260101] Governing Cloud Data Pipelines with Agentic AI**
  - **tags:** [mlsys], [fault-tolerance], [policy-aware control architecture, bounded AI agents, governance policies, adaptive resource reconfiguration, schema reconciliation, automated failure recovery]
  ...
  - **institution:** IEEE, Albertsons, Amtrak, Cato
  - **link:** https://arxiv.org/pdf/2512.23737
  - **Simple LLM Summary:** This paper proposes Agentic Cloud Data Engineering, a control architecture that integrates bounded AI agents to autonomously manage cloud data pipelines by analyzing telemetry and reasoning over governance policies. It demonstrates that this policy-bounded agentic approach significantly reduces recovery times, operational costs, and manual interventions while maintaining data freshness and compliance.

- **[arXiv260101] Time-varying Mixing Matrix Design for Energy-efficient Decentralized Federated Learning**
  - **tags:** [mlsys], [others], [mixing matrix design, decentralized federated learning, energy efficiency, time-varying communication topologies, multi-phase framework]
  ...
  - **Simple LLM Summary:** The paper proposes a multi-phase design framework for time-varying mixing matrices to minimize the maximum per-node energy consumption in decentralized federated learning over wireless networks. The method trades off per-iteration energy use and convergence rate by activating optimized communication topologies. Evaluations show it combines the low energy of sparse matrices with the fast convergence of dense matrices.

- **[arXiv260101] RedunCut: Measurement-Driven Sampling and Accuracy Performance Modeling for Low-Cost Live Video Analytics**
  - **tags:** [mlsys], [others], [dynamic model size selection, measurement-driven planner, data-driven performance model, sampling, accuracy prediction, video analytics]
  ...
  - **Simple LLM Summary:** RedunCut is a system for live video analytics that uses a measurement-driven planner to estimate the cost-benefit tradeoff of sampling different model sizes and a lightweight data-driven performance model to improve per-segment accuracy prediction. It reduces compute costs by 14-62% while maintaining a fixed accuracy target across diverse video workloads and model families.
...
- **[arXiv260101] VGC: A High-Performance Zone-Based Garbage Collector Architecture for Python with Partitioning and Parallel Execution**
  - **tags:** [sys], [memory management], [zone-based garbage collection, concurrent mark-and-sweep, predictive memory mapping, dual-layer architecture]
  - **authors:** Abdulla M
  - **institution:** Abdullahlab-n (inferred from GitHub organization)
  - **link:** https://arxiv.org/pdf/2512.23768
  - **Simple LLM Summary:** This paper introduces the Virtual Garbage Collector (VGC), a dual-layer architecture with an Active runtime component for concurrent mark-and-sweep and a Passive compile-time component for predictive memory mapping. It aims to reduce pause times and memory fragmentation in Python. The main conclusion is that VGC improves performance and scalability for memory-intensive, parallel applications compared to traditional garbage collectors.

- **[arXiv260101] Security Without Detection: Economic Denial as a Primitive for Edge and IoT Defense**
  - **tags:** [sys], [security], [Economic Denial Security, computational puzzles, decoy-driven interaction entropy, temporal stretching, bandwidth taxation, Stackelberg game, cost asymmetry]
  - **authors:** Samaresh Kumar Singh, Joyjit Roy
  - **institution:** IEEE
  - **link:** https://arxiv.org/pdf/2512.23849
  - **Simple LLM Summary:** This paper proposes Economic Denial Security (EDS), a detection-independent security framework for IoT/edge systems that imposes superlinear costs on attackers by combining four mechanisms: computational puzzles, decoy-driven interaction entropy, temporal stretching, and bandwidth taxation. It formalizes the approach as a Stackelberg game and demonstrates its effectiveness through evaluation, showing significant attack slowdown, cost asymmetry, and mitigation rates with minimal resource overhead. The core conclusion is that EDS shifts the economic balance in favor of defenders, providing viable protection for resource-constrained environments where traditional detection-based methods fail.

- **[arXiv260101] Distributed Bilevel Optimization with Dual Pruning for Resource-limited Clients**
  - **tags:** [mlsys], [others], [distributed bilevel optimization, resource-adaptive framework, second-order free hypergradient estimator, dual pruning, convergence analysis]
  ...
  - **Simple LLM Summary:** The paper proposes a resource-adaptive distributed bilevel optimization framework with a second-order free hypergradient estimator, allowing clients to optimize submodels based on their available resources. The method achieves an asymptotically optimal convergence rate dominated by the minimum coverage of the outer parameter. Experiments demonstrate its effectiveness and computational efficiency for resource-limited clients.

- **[arXiv260101] AI-Driven Cloud Resource Optimization for Multi-Cluster Environments**
  - **tags:** [mlsys], [cluster infrastructure], [predictive learning, policy-aware decision-making, continuous feedback, cross-cluster telemetry, adaptive resource optimization]
  - **authors:** Vinoth Punniyamoorthy, Akash Kumar Agarwal, Bikesh Kumar, Abhirup Mazumder, Kabilan Kannan, Sumit Saha
  - **institution:** IEEE, Albertsons, East West Bank
  - **link:** https://arxiv.org/pdf/2512.24914
  - **Simple LLM Summary:** This paper proposes an AI-driven framework that uses predictive learning and policy-aware decision-making to proactively optimize resource allocation across multi-cluster cloud environments. The method analyzes cross-cluster telemetry to dynamically balance performance, cost, and reliability. The prototype demonstrates improved resource efficiency and faster stabilization compared to reactive approaches, highlighting intelligent management as key for scalable cloud platforms.

- **[arXiv260101] Document Data Matching for Blockchain-Supported Real Estate**
  - **tags:** [mlsys], [others], [optical character recognition, natural language processing, verifiable credentials, blockchain, data matching]
  ...
  - **Simple LLM Summary:** This paper presents a system that integrates OCR and NLP to extract data from real estate documents, converts this data into standardized verifiable credentials, and uses blockchain for verification and trust. The prototype demonstrates automated data matching to detect inconsistencies and reduces verification time while maintaining reliability. The framework shows potential for streamlining real estate transactions and enhancing security through scalable digital processes.

- **[arXiv260101] Understanding LLM Checkpoint/Restore I/O Strategies and Patterns**
  - **tags:** [mlsys], [fault-tolerance], [checkpoint/restore, liburing, I/O coalescing, aggregation, 3D parallelism, microbenchmarks]
  ...
  - **Simple LLM Summary:** This paper investigates I/O strategies for checkpointing and restoring large language models, focusing on using the kernel-accelerated `liburing` library to improve performance. Through microbenchmarks, it finds that file system-aware aggregation and I/O coalescing are crucial for mitigating bottlenecks. The proposed approach achieves significantly higher write throughput compared to existing checkpointing engines like DataStates-LLM and TorchSnapshot.

- **[arXiv260101] Vulcan: Instance-Optimal Systems Heuristics Through LLM-Driven Search**
  - **tags:** [mlsys], [others], [LLM-driven search, evolutionary search, instance-optimal heuristics, policy-mechanism separation, code generation]
  ...
  - **Simple LLM Summary:** The paper introduces Vulcan, a framework that uses large language models (LLMs) combined with evolutionary search to automatically synthesize instance-optimal heuristics for system resource-management tasks like caching and memory tiering. It separates policy and mechanism through LLM-friendly interfaces to make the search tractable. The synthesized heuristics outperform state-of-the-art human-designed algorithms by up to 69% and 7.9% in the evaluated tasks.

- **[arXiv260101] Reliable and Resilient Collective Communication Library for LLM Training and Serving**
  - **tags:** [mlsys], [fault-tolerance], [collective communication, connection migration, load redistribution, resilient algorithms, multi-NIC hardware]
  - **authors:** Wei Wang, Nengneng Yu, Sixian Xiong, Zaoxing Liu
  - **institution:** University of Maryland, College Park
  - **link:** https://arxiv.org/pdf/2512.25059
  - **Simple LLM Summary:** The paper presents R²CCL, a fault-tolerant communication library for large-scale ML that uses rapid connection migration, bandwidth-aware load redistribution, and resilient collective algorithms to handle network failures. It exploits multi-NIC hardware to provide lossless failover, significantly reducing recovery overhead. Experiments show it incurs minimal performance overhead and greatly outperforms existing baselines in both training and inference scenarios.

- **[arXiv260101] Adaptive Resource Orchestration for Distributed Quantum Computing Systems**
  - **tags:** [sys], [quantum computing systems], [Modular Entanglement Hub, quantum teleportation, entanglement orchestration, hub-and-spoke interconnect, ebit cache, Monte Carlo simulation]
  ...
  - **Simple LLM Summary:** The paper proposes the Modular Entanglement Hub (ModEn-Hub) architecture, which uses a central hub with a quantum network orchestrator to manage on-demand entanglement generation and teleportation across distributed quantum processors. Through Monte Carlo simulation, it demonstrates that this adaptive orchestration sustains high teleportation success rates (around 90%) across many QPUs, significantly outperforming a naive sequential baseline.


**cs.AI/cs.LG contains "reinforcement learning" total: 32**
- [arXiv260101] GARDO: Reinforcing Diffusion Models without Reward Hacking [link](https://arxiv.org/pdf/2512.24138)
- [arXiv260101] Audited Skill-Graph Self-Improvement for Agentic LLMs via Verifiable Rewards, Experience Synthesis, and Continual Memory [link](https://arxiv.org/pdf/2512.23760)
- [arXiv260101] Deep Reinforcement Learning for Solving the Fleet Size and Mix Vehicle Routing Problem [link](https://arxiv.org/pdf/2512.24251)
- [arXiv260101] Constraint Breeds Generalization: Temporal Dynamics as an Inductive Bias [link](https://arxiv.org/pdf/2512.23916)
- [arXiv260101] Safety-Biased Policy Optimisation: Towards Hard-Constrained Reinforcement Learning via Trust Regions [link](https://arxiv.org/pdf/2512.23770)
- [arXiv260101] FineFT: Efficient and Risk-Aware Ensemble Reinforcement Learning for Futures Trading [link](https://arxiv.org/pdf/2512.23773)
- [arXiv260101] Max-Entropy Reinforcement Learning with Flow Matching and A Case Study on LQR [link](https://arxiv.org/pdf/2512.23870)
- [arXiv260101] Prompt-Induced Over-Generation as Denial-of-Service: A Black-Box Attack-Side Benchmark [link](https://arxiv.org/pdf/2512.23779)
- [arXiv260101] Efficient Inference for Inverse Reinforcement Learning and Dynamic Discrete Choice Models [link](https://arxiv.org/pdf/2512.24407)
- [arXiv260101] A Survey of AI Methods for Geometry Preparation and Mesh Generation in Engineering Simulation [link](https://arxiv.org/pdf/2512.23719)
- [arXiv260101] Adaptive Learning Guided by Bias-Noise-Alignment Diagnostics [link](https://arxiv.org/pdf/2512.24445)
- [arXiv260101] MaRCA: Multi-Agent Reinforcement Learning for Dynamic Computation Allocation in Large-Scale Recommender Systems [link](https://arxiv.org/pdf/2512.24325)
- [arXiv260101] DRL-TH: Jointly Utilizing Temporal Graph Attention and Hierarchical Fusion for UGV Navigation in Crowded Environments [link](https://arxiv.org/pdf/2512.24284)
- [arXiv260101] ROAD: Reflective Optimization via Automated Debugging for Zero-Shot Agent Alignment [link](https://arxiv.org/pdf/2512.24040)
- [arXiv260101] RSAgent: Learning to Reason and Act for Text-Guided Segmentation via Multi-Turn Tool Invocations [link](https://arxiv.org/pdf/2512.24023)
- [arXiv260101] From Building Blocks to Planning: Multi-Step Spatial Reasoning in LLMs with Reinforcement Learning [link](https://arxiv.org/pdf/2512.24532)
- [arXiv260101] From Perception to Punchline: Empowering VLM with the Art of In-the-wild Meme [link](https://arxiv.org/pdf/2512.24555)
- [arXiv260101] Reinforcement Learning-Augmented LLM Agents for Collaborative Decision Making and Performance Optimization [link](https://arxiv.org/pdf/2512.24609)
- [arXiv260101] Youtu-Agent: Scaling Agent Productivity with Automated Generation and Hybrid Policy Optimization [link](https://arxiv.org/pdf/2512.24615)
- [arXiv260101] Hybrid Motion Planning with Deep Reinforcement Learning for Mobile Robot Navigation [link](https://arxiv.org/pdf/2512.24651)
- [arXiv260101] Evolving, Not Training: Zero-Shot Reasoning Segmentation via Evolutionary Prompting [link](https://arxiv.org/pdf/2512.24702)
- [arXiv260101] Dream2Flow: Bridging Video Generation and Open-World Manipulation with 3D Object Flow [link](https://arxiv.org/pdf/2512.24766)
- [arXiv260101] Iterative Deployment Improves Planning Skills in LLMs [link](https://arxiv.org/pdf/2512.24940)
- [arXiv260101] MSACL: Multi-Step Actor-Critic Learning with Lyapunov Certificates for Exponentially Stabilizing Control [link](https://arxiv.org/pdf/2512.24955)
- [arXiv260101] ResponseRank: Data-Efficient Reward Modeling through Preference Strength Learning [link](https://arxiv.org/pdf/2512.25023)
- [arXiv260101] Many Minds from One Model: Bayesian Transformers for Population Intelligence [link](https://arxiv.org/pdf/2512.25063)
- [arXiv260101] Scaling Open-Ended Reasoning to Predict the Future [link](https://arxiv.org/pdf/2512.25070)
- [arXiv260101] Fitted Q Evaluation Without Bellman Completeness via Stationary Weighting [link](https://arxiv.org/pdf/2512.23805)
- [arXiv260101] Stationary Reweighting Yields Local Convergence of Soft Fitted Q-Iteration [link](https://arxiv.org/pdf/2512.23927)
- [arXiv260101] Policy Mirror Descent with Temporal Difference Learning: Sample Complexity under Online Markov Data [link](https://arxiv.org/pdf/2512.24056)
- [arXiv260101] Robust Bayesian Dynamic Programming for On-policy Risk-sensitive Reinforcement Learning [link](https://arxiv.org/pdf/2512.24580)
- [arXiv260101] Sparse Offline Reinforcement Learning with Corruption Robustness [link](https://arxiv.org/pdf/2512.24768)

**cs.AI/cs.LG contains "accelerate" total: 15**
- [arXiv260101] Learning Coupled System Dynamics under Incomplete Physical Constraints and Missing Data [link](https://arxiv.org/pdf/2512.23761)
- [arXiv260101] DermaVQA-DAS: Dermatology Assessment Schema (DAS) & Datasets for Closed-Ended Question Answering & Segmentation in Patient-Generated Dermatology Images [link](https://arxiv.org/pdf/2512.24340)
- [arXiv260101] SCP: Accelerating Discovery with a Global Web of Autonomous Scientific Agents [link](https://arxiv.org/pdf/2512.24189)
- [arXiv260101] Enabling Physical AI at the Edge: Hardware-Accelerated Recovery of System Dynamics [link](https://arxiv.org/pdf/2512.23767)
- [arXiv260101] A Survey of AI Methods for Geometry Preparation and Mesh Generation in Engineering Simulation [link](https://arxiv.org/pdf/2512.23719)
- [arXiv260101] Joint Selection for Large-Scale Pre-Training Data via Policy Gradient-based Mask Learning [link](https://arxiv.org/pdf/2512.24265)
- [arXiv260101] Entropy-Aware Speculative Decoding Toward Improved LLM Reasoning [link](https://arxiv.org/pdf/2512.23765)
- [arXiv260101] VLA-RAIL: A Real-Time Asynchronous Inference Linker for VLA Models and Robots [link](https://arxiv.org/pdf/2512.24673)
- [arXiv260101] FPGA Co-Design for Efficient N:M Sparse and Quantized Model Inference [link](https://arxiv.org/pdf/2512.24713)
- [arXiv260101] Big AI is accelerating the metacrisis: What can we do? [link](https://arxiv.org/pdf/2512.24863)
- [arXiv260101] Semi-Automated Data Annotation in Multisensor Datasets for Autonomous Vehicle Testing [link](https://arxiv.org/pdf/2512.24896)
- [arXiv260101] q3-MuPa: Quick, Quiet, Quantitative Multi-Parametric MRI using Physics-Informed Diffusion Models [link](https://arxiv.org/pdf/2512.23726)
- [arXiv260101] A multimodal Transformer for InSAR-based ground deformation forecasting with cross-site generalization across Europe [link](https://arxiv.org/pdf/2512.23906)
- [arXiv260101] An Adaptive, Disentangled Representation for Multidimensional MRI Reconstruction [link](https://arxiv.org/pdf/2512.24674)
- [arXiv260101] Are First-Order Diffusion Samplers Really Slower? A Fast Forward-Value Approach [link](https://arxiv.org/pdf/2512.24927)
