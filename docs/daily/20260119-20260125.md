...
- **[arXiv260123] DSFedMed: Dual-Scale Federated Medical Image Segmentation via Mutual Distillation Between Foundation and Lightweight Models**
  - **tags:** [mlsys], [others], [federated learning, knowledge distillation, medical image segmentation, foundation model, lightweight model, mutual distillation, sample selection]
  - **authors:** Hanwen Zhang, Qiaojin Shen, Yuxi Liu, Yuesheng Zhu, Guibo Luo
  - **institution:** Peking University
  - **link:** https://arxiv.org/pdf/2601.16073
  - **Simple LLM Summary:** The paper proposes DSFedMed, a dual-scale federated learning framework that uses mutual knowledge distillation between a central foundation model and lightweight client models for medical image segmentation. It employs generated data and a learnability-guided selection strategy to improve efficiency. The method achieves higher accuracy with significantly reduced communication and inference costs compared to federated foundation model baselines.

- **[arXiv260123] Advancing RT Core-Accelerated Fixed-Radius Nearest Neighbor Search**
  - **tags:** [sys], [GPU Computing], [RT cores, bounding volume hierarchy, fixed-radius nearest neighbor search, periodic boundary conditions]
  ...
  - **institution:** Universidad Austral de Chile, University of Limoges, University of Chile
  - **link:** https://arxiv.org/pdf/2601.15633
  - **Simple LLM Summary:** This paper introduces three techniques to improve particle physics simulations using RT cores for fixed-radius nearest neighbor search: a real-time optimizer for the bounding volume hierarchy, a method to eliminate neighbor lists, and support for periodic boundary conditions. The methods significantly accelerate simulations, improve energy efficiency, and scale across GPU generations, while also identifying cases where traditional GPU computation remains preferable.

- **[arXiv260123] Securing LLM-as-a-Service for Small Businesses: An Industry Case Study of a Distributed Chatbot Deployment Platform**
  - **tags:** [mlsys], [cluster infrastructure], [retrieval-augmented generation (RAG), k3s clusters, encrypted overlay network, container-based isolation, prompt injection defense, multi-tenant platform]
  - **authors:** Jiazhu Xie, Bowen Li, Heyu Fu, Chong Gao, Ziqi Xu, Fengling Han
  - **institution:** RMIT University
  - **link:** https://arxiv.org/pdf/2601.15528
  - **Simple LLM Summary:** This paper presents a distributed, open-source platform built on lightweight k3s clusters to help small businesses deploy secure, multi-tenant LLM-based chatbots using a no-code workflow. The platform integrates defenses against prompt injection attacks and uses resource pooling across low-cost machines. The evaluation demonstrates that secure and efficient LLM-as-a-Service can be achieved under the cost and operational constraints of small businesses.

- **[arXiv260123] Scaling Sample-Based Quantum Diagonalization on GPU-Accelerated Systems using OpenMP Offload**
  - **tags:** [mlsys], [GPU kernels], [OpenMP offload, Davidson algorithm, quantum diagonalization, GPU acceleration, hybrid quantum-HPC]
  ...
  - **institution:** IBM Research, Advanced Micro Devices, Inc., Oak Ridge National Laboratory
  - **link:** https://arxiv.org/pdf/2601.16169
  - **Simple LLM Summary:** This paper presents a hybrid quantum-HPC method called sample-based quantum diagonalization (SQD), offloading the computationally intensive diagonalization step to GPU-accelerated systems using OpenMP offload. The core method involves using the Davidson algorithm on a classical computer to process configurations from a quantum processor. The main conclusion is that GPU acceleration provides a performance boost of about 100x per node, significantly reducing classical processing time from hours to minutes.


**cs.AI/cs.LG contains "reinforcement learning" total: 16**
- [arXiv260123] Off-Policy Actor-Critic with Sigmoid-Bounded Entropy for Real-World Robot Learning [link](https://arxiv.org/pdf/2601.15761)
- [arXiv260123] Decoupling Return-to-Go for Efficient Decision Transformer [link](https://arxiv.org/pdf/2601.15953)
- [arXiv260123] ICPO: Illocution-Calibrated Policy Optimization for Multi-Turn Conversation [link](https://arxiv.org/pdf/2601.15330)
- [arXiv260123] Dancing in Chains: Strategic Persuasion in Academic Rebuttal via Theory of Mind [link](https://arxiv.org/pdf/2601.15715)
- [arXiv260123] Performance-guided Reinforced Active Learning for Object Detection [link](https://arxiv.org/pdf/2601.15688)
- [arXiv260123] From Passive Metric to Active Signal: The Evolving Role of Uncertainty Quantification in Large Language Models [link](https://arxiv.org/pdf/2601.15690)
- [arXiv260123] Statistical Reinforcement Learning in the Real World: A Survey of Challenges and Future Directions [link](https://arxiv.org/pdf/2601.15353)
- [arXiv260123] When Sharpening Becomes Collapse: Sampling Bias and Semantic Coupling in RL with Verifiable Rewards [link](https://arxiv.org/pdf/2601.15609)
- [arXiv260123] Structured Hints for Sample-Efficient Lean Theorem Proving [link](https://arxiv.org/pdf/2601.16172)
- [arXiv260123] Learning to Discover at Test Time [link](https://arxiv.org/pdf/2601.16175)
- [arXiv260123] LLM-in-Sandbox Elicits General Agentic Intelligence [link](https://arxiv.org/pdf/2601.16206)
- [arXiv260123] Robust Tool Use via Fission-GRPO: Learning to Recover from Execution Errors [link](https://arxiv.org/pdf/2601.15625)
- [arXiv260123] PUMA: Perception-driven Unified Foothold Prior for Mobility Augmented Quadruped Parkour [link](https://arxiv.org/pdf/2601.15995)
- [arXiv260123] Non-Stationary Functional Bilevel Optimization [link](https://arxiv.org/pdf/2601.15363)
- [arXiv260123] PhysProver: Advancing Automatic Theorem Proving for Physics [link](https://arxiv.org/pdf/2601.15737)
- [arXiv260123] Q-Probe: Scaling Image Quality Assessment to High Resolution via Context-Aware Agentic Probing [link](https://arxiv.org/pdf/2601.15356)

**cs.AI/cs.LG contains "accelerate" total: 7**
- [arXiv260123] ToolCaching: Towards Efficient Caching for LLM Tool-calling [link](https://arxiv.org/pdf/2601.15335)
- [arXiv260123] MARS: Unleashing the Power of Speculative Decoding via Margin-Aware Verification [link](https://arxiv.org/pdf/2601.15498)
- [arXiv260123] Aeon: High-Performance Neuro-Symbolic Memory Management for Long-Horizon LLM Agents [link](https://arxiv.org/pdf/2601.15311)
- [arXiv260123] Skywork UniPic 3.0: Unified Multi-Image Composition via Sequence Modeling [link](https://arxiv.org/pdf/2601.15664)
- [arXiv260123] FlexLLM: Composable HLS Library for Flexible Hybrid LLM Accelerator Design [link](https://arxiv.org/pdf/2601.15710)
- [arXiv260123] A Rolling-Space Branch-and-Price Algorithm for the Multi-Compartment Vehicle Routing Problem with Multiple Time Windows [link](https://arxiv.org/pdf/2601.16194)
- [arXiv260123] Low-Dimensional Adaptation of Rectified Flow: A New Perspective through the Lens of Diffusion and Stochastic Localization [link](https://arxiv.org/pdf/2601.15500)
