...
- **[arXiv260206] FedRandom: Sampling Consistent and Accurate Contribution Values in Federated Learning**
  - **tags:** [mlsys], [others], [FedRandom, contribution estimation, statistical sampling, client contribution, federated learning]
  - **authors:** Arno Geimer, Beltran Fiz Pontiveros, Radu State
  - **institution:** University of Luxembourg
  - **link:** https://arxiv.org/pdf/2602.05693
  - **Simple LLM Summary:** The paper introduces FedRandom, a novel method that treats contribution estimation instability in Federated Learning as a statistical problem, allowing the generation of more samples for evaluation. It demonstrates that this approach provides more consistent and reliable assessments of participant contributions, significantly reducing the distance to ground truth and improving stability across multiple datasets.

- **[arXiv260206] Sovereign-by-Design A Reference Architecture for AI and Blockchain Enabled Systems**
  - **tags:** [mlsys], [others], [self-sovereign identity, blockchain, trust, auditability, sovereign data governance, reference architecture]
  - **authors:** Matteo Esposito, Lodovica Marchesi, Roberto Tonelli, Valentina Lenarduzzi
  - **institution:** University of Oulu, University of Cagliari, University of Southern Denmark
  - **link:** https://arxiv.org/pdf/2602.05486
  - **Simple LLM Summary:** This paper proposes a Sovereign Reference Architecture that integrates self-sovereign identity, blockchain, and controlled Generative AI to operationalize digital sovereignty as a core architectural property. It concludes that framing sovereignty as a quality attribute bridges regulatory goals with system design, providing a foundation for building auditable and jurisdiction-aware AI systems.

- **[arXiv260206] Emergence-as-Code for Self-Governing Reliable Systems**
  - **tags:** [sys], [reliability engineering], [SLO-as-code, microservices, GitOps, control-flow operators, burn-rate alerts]
  - **authors:** Anatoly A. Krasnovsky
  - **institution:** Innopolis University, MB3R Lab
  - **link:** https://arxiv.org/pdf/2602.05458
  - **Simple LLM Summary:** The paper proposes Emergence-as-Code (EmaC), a method to make the reliability of end-to-end user journeys in microservices computable and governable by combining explicit intent specifications with runtime evidence from system telemetry. It concludes that this approach can automatically derive bounded journey SLOs and generate control-plane artifacts, thereby preventing reliability drift and enabling self-governing systems.

- **[arXiv260206] Proteus: Append-Only Ledgers for (Mostly) Trusted Execution Environments**
  - **tags:** [sys], [distributed consensus protocols], [trusted execution environments, crash-fault-tolerant consensus, byzantine fault-tolerant consensus, append-only ledgers, layered security]
  - **authors:** Shubham Mishra, João Gonçalves, Chawinphat Tankuranand, Neil Giridharan, Natacha Crooks, Heidi Howard, Chris Jensen
  - **institution:** UC Berkeley, Microsoft, IST U. Lisboa & INESC-ID
  - **link:** https://arxiv.org/pdf/2602.05346
  - **Simple LLM Summary:** The paper introduces Proteus, a distributed consensus protocol that embeds a Byzantine fault-tolerant (BFT) protocol inside a crash-fault-tolerant (CFT) protocol without adding extra messages, by aligning their structures. This approach cautiously trusts hardware-based Trusted Execution Environments (TEEs) to maintain performance while guaranteeing data integrity even if TEEs are compromised.

- **[arXiv260206] Smoothed aggregation algebraic multigrid for problems with heterogeneous and anisotropic materials**
  - **tags:** [sys], [numerical methods], [smoothed aggregation algebraic multigrid, strength-of-connection, material tensor, coarsening, heterogeneous materials, anisotropic materials]
  - **authors:** Max Firmbach, Malachi Phillips, Christian Glusa, Alexander Popp, Christopher M. Siefert, Matthias Mayr
  - **institution:** Universität der Bundeswehr München, Sandia National Laboratories
  - **link:** https://arxiv.org/pdf/2602.05686
  - **Simple LLM Summary:** This paper proposes a new material-aware strength-of-connection measure for smoothed aggregation algebraic multigrid methods. The method directly incorporates material tensor information into the coarsening process to better handle problems with heterogeneous and anisotropic properties. The results demonstrate improved robustness and scalability for challenging real-world applications like battery and solar cell simulations.

- **[arXiv260206] Reaching Univalency with Subquadratic Communication**
  - **tags:** [sys], [distributed computing, Byzantine Agreement], [Dolev-Reischuk lower bound, univalency, dissemination, deterministic protocol, communication complexity, epsilon-BA, Extractable BA]
  - **authors:** Andrew Lewis-Pye
  - **institution:** Not explicitly provided in the text. Author name only; institution cannot be reliably inferred.
  - **link:** https://arxiv.org/pdf/2602.05356
  - **Simple LLM Summary:** The paper introduces a relaxed Byzantine Agreement problem called epsilon-BA, which allows a small fraction of correct processors to output incorrectly, and shows it can be solved deterministically with O(n log n) communication. This demonstrates that the quadratic communication cost in the classic Dolev-Reischuk lower bound is due to disseminating the outcome to all processors, not to reaching the point of univalency where the outcome is determined.

- **[arXiv260206] ORACL: Optimized Reasoning for Autoscaling via Chain of Thought with LLMs for Microservices**
  - **tags:** [mlsys], [llm inference], [chain-of-thought reasoning, instruction tuning, supervised fine-tuning, reinforcement learning, root cause analysis]
  - **authors:** Haoyu Bai, Muhammed Tawfiqul Islam, Minxian Xu, Rajkumar Buyya
  - **institution:** The University of Melbourne, Shenzhen Institute of Advanced Technology, Chinese Academy of Sciences
  - **link:** https://arxiv.org/pdf/2602.05292
  - **Simple LLM Summary:** This paper proposes ORACL, a framework that uses Large Language Models (LLMs) with chain-of-thought reasoning to perform autoscaling and root cause analysis for microservices. The method transforms runtime telemetry into natural language descriptions and uses the LLM to generate interpretable reasoning traces for resource allocation decisions. The experiments show that ORACL improves root-cause identification accuracy, accelerates training, and enhances quality of service without requiring deployment-specific retraining.

- **[arXiv260206] Evaluating Kubernetes Performance for GenAI Inference: From Automatic Speech Recognition to LLM Summarization**
  - **tags:** [mlsys], [llm inference], [Kubernetes, Kueue, Dynamic Accelerator Slicer (DAS), Gateway API Inference Extension (GAIE), batch inference, online inference, automatic speech recognition, summarization]
  - **authors:** Sai Sindhur Malleni, Raúl Sevilla, Aleksei Vasilevskii, José Castillo Lema, André Bauer
  - **institution:** Red Hat, Illinois Institute of Technology
  - **link:** https://arxiv.org/pdf/2602.04900
  - **Simple LLM Summary:** This paper evaluates a Kubernetes-native platform for multi-stage Generative AI inference, combining Kueue for batch job management, Dynamic Accelerator Slicer for parallel execution, and the Gateway API Inference Extension for optimized online request routing. The implementation demonstrates significant performance improvements for an automatic speech recognition and summarization workflow. The findings show that Kubernetes can serve as a unified, high-performance foundation for demanding GenAI workloads.

- **[arXiv260206] Towards Advancing Research with Workflows: A perspective from the Workflows Community Summit -- Amsterdam, 2025**
  - **tags:** [sys], [scientific workflows], [workflow orchestration, reproducibility, community-driven benchmarks, sustainability, standardization]
  - **authors:** Irene Bonati, Silvina Caino-Lores, Tainã Coleman, Sagar Dolas, Sandro Fiore, Venkatesh Kannan, Marco Verdicchio, Sean R. Wilkinson, Rafael Ferreira da Silva
  - **institution:** SURF Cooperation, University of Rennes, San Diego Computing Center, University of Trento, Irish Centre for High-End Computing, Oak Ridge National Laboratory
  - **link:** https://arxiv.org/pdf/2602.05131
  - **Simple LLM Summary:** This paper presents the findings of the 2025 Workflows Community Summit, which examined challenges and opportunities in using scientific workflows for research. The core method involves community-driven discussion to identify barriers like sustainability and lack of recognition, and to propose action lines focusing on scientific impact, formalized patterns, and community building. The main conclusion is that advancing research with workflows requires a paradigm shift from measuring raw performance to evaluating scientific utility, alongside investments in standardization, training, and a cohesive international community.

- **[arXiv260206] A novel scalable high performance diffusion solver for multiscale cell simulations**
  - **tags:** [sys], [computational biology simulation], [Finite Volume Method, BioFVM, OpenMP, MPI, parallel algorithms, tridiagonal solver, distributed computing]
  - **authors:** Jose-Luis Estragues-Muñoz, Carlos Alvarez, Arnau Montagud, Daniel Jimenez-Gonzalez, Alfonso Valencia
  - **institution:** Barcelona Supercomputing Center (BSC), Universitat Politecnica de Catalunya (UPC), Institute for Integrative Systems Biology (I2SysBio), CSIC-UV, ICREA
  - **link:** https://arxiv.org/pdf/2602.05017
  - **Simple LLM Summary:** This paper presents a scalable high-performance computing (HPC) solution for molecular diffusion in multiscale cell simulations, based on an efficient implementation of the Finite Volume Method (FVM) in a novel Biological Finite Volume Method (BioFVM) library. The proposed HPC solution achieves nearly a 200x speedup and up to 36% reduction in memory usage compared to current state-of-the-art methods, enabling efficient simulation of large-scale biological problems like tumor growth for digital twin models.

- **[arXiv260206] Location-Aware Dispersion on Anonymous Graphs**
  - **tags:** [sys], [distributed robotics], [deterministic algorithms, mobile robots, anonymous graphs, dispersion problem, location-aware dispersion, lower bounds]
  - **authors:** Himani, Supantha Pandit, Gokarna Sharma
  - **institution:** Dhirubhai Ambani University, Kent State University
  - **link:** https://arxiv.org/pdf/2602.05948
  - **Simple LLM Summary:** The paper introduces Location-Aware Dispersion, a generalization of the Dispersion problem where robots must relocate to distinct nodes matching their assigned colors in an anonymous graph. It presents several deterministic algorithms with bounds on time and memory, along with impossibility results and lower bounds. The results establish the algorithmic feasibility of the problem while highlighting its increased complexity compared to standard Dispersion.

- **[arXiv260206] TimelyFreeze: Adaptive Parameter Freezing Mechanism for Pipeline Parallelism**
  - **tags:** [mlsys], [llm training], [pipeline parallelism, parameter freezing, directed acyclic graph, linear programming, GPipe, 1F1B]
  - **authors:** Seonghye Cho, Jaemin Han, Hyunjin Kim, Euisoo Jung, Jae-Gil Lee
  - **institution:** KAIST
  - **link:** https://arxiv.org/pdf/2602.05754
  - **Simple LLM Summary:** The paper proposes TimelyFreeze, an adaptive parameter freezing mechanism that models the pipeline schedule as a directed acyclic graph and uses linear programming to compute optimal freeze ratios, minimizing batch execution time under accuracy constraints. It achieves up to 40% training throughput improvement on models like LLaMA-8B while maintaining comparable accuracy, enabling faster large-scale model training without compromising convergence.

- **[arXiv260206] Distributed Quantum Error Mitigation: Global and Local ZNE encodings**
  - **tags:** [sys], [distributed quantum computing], [Zero Noise Extrapolation (ZNE), circuit partitioning, teleportation-based communication, error mitigation, quantum networks]
  - **authors:** Maria Gragera Garces
  - **institution:** University of Edinburgh
  - **link:** https://arxiv.org/pdf/2602.04981
  - **Simple LLM Summary:** This paper investigates Zero Noise Extrapolation (ZNE) for error mitigation in distributed quantum computing, comparing a Global approach (applied before circuit partitioning) against a Local approach (applied to each sub-circuit). The results show that Global ZNE scales better, achieving up to 48% error reduction across six quantum processors, and reveals the counterintuitive finding that increasing the number of processors can improve mitigation despite higher communication noise.

- **[arXiv260206] The Quantum Message Complexity of Distributed Wake-Up with Advice**
  - **tags:** [sys], [distributed computing], [quantum routing model, wake-up problem, message complexity, advice, lower bound, upper bound]
  - **authors:** Peter Robinson, Ming Ming Tan
  - **institution:** Augusta University
  - **link:** https://arxiv.org/pdf/2602.05801
  - **Simple LLM Summary:** This paper studies the distributed wake-up problem in a quantum routing model, where nodes receive advice from an oracle. It presents an algorithm with a message complexity of O(√(n³/2^(max\{⌊(α-1)/2⌋,0\}))·log n) given α bits of advice per node, breaking a known classical lower bound, and proves an Ω(n^(3/2)) lower bound for quantum wake-up without advice.

- **[arXiv260206] From Sequential to Parallel: Reformulating Dynamic Programming as GPU Kernels for Large-Scale Stochastic Combinatorial Optimization**
  - **tags:** [mlsys], [GPU kernels], [dynamic programming, GPU kernels, scenario batching, Bellman updates, stochastic programming, sample average approximation]
  - **authors:** Jingyi Zhao, Linxin Yang, Haohua Zhang, Tian Ding
  - **institution:** Shenzhen Research Institute of Big Data, The Chinese University of Hongkong, Shenzhen, Shenzhen International Center for Industrial and Applied Mathematics, AutoKernel
  - **link:** https://arxiv.org/pdf/2602.05179
  - **Simple LLM Summary:** This paper introduces a GPU-based framework that reformulates dynamic programming as parallel hardware-aware kernels to solve large-scale stochastic combinatorial optimization problems. The method enables massive parallelization across scenarios and DP layers, achieving orders of magnitude speedup. The results demonstrate that full-fidelity integer second-stage models become tractable at previously impossible scales, improving decision quality in stochastic programming.


**cs.AI/cs.LG contains "reinforcement learning" total: 37**
- [arXiv260206] ReFORM: Reflected Flows for On-support Offline RL via Noise Manipulation [link](https://arxiv.org/pdf/2602.05051)
- [arXiv260206] Laplacian Representations for Decision-Time Planning [link](https://arxiv.org/pdf/2602.05031)
- [arXiv260206] GAS: Enhancing Reward-Cost Balance of Generative Model-assisted Offline Safe RL [link](https://arxiv.org/pdf/2602.05323)
- [arXiv260206] Euphonium: Steering Video Flow Matching via Process Reward Gradient Guided Stochastic Dynamics [link](https://arxiv.org/pdf/2602.04928)
- [arXiv260206] Beware Untrusted Simulators -- Reward-Free Backdoor Attacks in Reinforcement Learning [link](https://arxiv.org/pdf/2602.05089)
- [arXiv260206] EBPO: Empirical Bayes Shrinkage for Stabilizing Group-Relative Policy Optimization [link](https://arxiv.org/pdf/2602.05165)
- [arXiv260206] Data-Centric Interpretability for LLM-based Multi-Agent Reinforcement Learning [link](https://arxiv.org/pdf/2602.05183)
- [arXiv260206] A Unified Framework for Rethinking Policy Divergence Measures in GRPO [link](https://arxiv.org/pdf/2602.05494)
- [arXiv260206] Back to Basics: Revisiting Exploration in Reinforcement Learning for LLM Reasoning via Generative Probabilities [link](https://arxiv.org/pdf/2602.05281)
- [arXiv260206] Gradually Compacting Large Language Models for Reasoning Like a Boiling Frog [link](https://arxiv.org/pdf/2602.04919)
- [arXiv260206] Unveiling Implicit Advantage Symmetry: Why GRPO Struggles with Exploration and Difficulty Adaptation [link](https://arxiv.org/pdf/2602.05548)
- [arXiv260206] Privileged Information Distillation for Language Models [link](https://arxiv.org/pdf/2602.04942)
- [arXiv260206] Reinforcement Learning Enhancement Using Vector Semantic Representation and Symbolic Reasoning for Human-Centered Autonomous Emergency Braking [link](https://arxiv.org/pdf/2602.05079)
- [arXiv260206] Mode-Dependent Rectification for Stable PPO Training [link](https://arxiv.org/pdf/2602.05619)
- [arXiv260206] Optimizing Mission Planning for Multi-Debris Rendezvous Using Reinforcement Learning with Refueling and Adaptive Collision Avoidance [link](https://arxiv.org/pdf/2602.05075)
- [arXiv260206] Rewards as Labels: Revisiting RLVR from a Classification Perspective [link](https://arxiv.org/pdf/2602.05630)
- [arXiv260206] When Are RL Hyperparameters Benign? A Study in Offline Goal-Conditioned RL [link](https://arxiv.org/pdf/2602.05459)
- [arXiv260206] UAV Trajectory Optimization via Improved Noisy Deep Q-Network [link](https://arxiv.org/pdf/2602.05644)
- [arXiv260206] ALIVE: Awakening LLM Reasoning via Adversarial Learning and Instructive Verbal Evaluation [link](https://arxiv.org/pdf/2602.05472)
- [arXiv260206] Formal Synthesis of Certifiably Robust Neural Lyapunov-Barrier Certificates [link](https://arxiv.org/pdf/2602.05311)
- [arXiv260206] Anchored Policy Optimization: Mitigating Exploration Collapse Via Support-Constrained Rectification [link](https://arxiv.org/pdf/2602.05717)
- [arXiv260206] Mitigating Hallucination in Financial Retrieval-Augmented Generation via Fine-Grained Knowledge Verification [link](https://arxiv.org/pdf/2602.05723)
- [arXiv260206] Learning to Inject: Automated Prompt Injection via Reinforcement Learning [link](https://arxiv.org/pdf/2602.05746)
- [arXiv260206] RL-VLA$^3$: Reinforcement Learning VLA Accelerating via Full Asynchronism [link](https://arxiv.org/pdf/2602.05765)
- [arXiv260206] Cross-Domain Offline Policy Adaptation via Selective Transition Correction [link](https://arxiv.org/pdf/2602.05776)
- [arXiv260206] Distributional Reinforcement Learning with Diffusion Bridge Critics [link](https://arxiv.org/pdf/2602.05783)
- [arXiv260206] TKG-Thinker: Towards Dynamic Reasoning over Temporal Knowledge Graphs via Agentic Reinforcement Learning [link](https://arxiv.org/pdf/2602.05818)
- [arXiv260206] Dr. Kernel: Reinforcement Learning Done Right for Triton Kernel Generations [link](https://arxiv.org/pdf/2602.05885)
- [arXiv260206] DFPO: Scaling Value Modeling via Distributional Flow towards Robust and Generalizable LLM Post-Training [link](https://arxiv.org/pdf/2602.05890)
- [arXiv260206] Quantum Reinforcement Learning with Transformers for the Capacitated Vehicle Routing Problem [link](https://arxiv.org/pdf/2602.05920)
- [arXiv260206] Approximation of Log-Partition Function in Policy Mirror Descent Induces Implicit Regularization for LLM Post-Training [link](https://arxiv.org/pdf/2602.05933)
- [arXiv260206] $f$-GRPO and Beyond: Divergence-Based Reinforcement Learning Algorithms for General LLM Alignment [link](https://arxiv.org/pdf/2602.05946)
- [arXiv260206] Learning to Share: Selective Memory for Efficient Parallel Agentic Systems [link](https://arxiv.org/pdf/2602.05965)
- [arXiv260206] On Computation and Reinforcement Learning [link](https://arxiv.org/pdf/2602.05999)
- [arXiv260206] Learning Query-Aware Budget-Tier Routing for Runtime Agent Memory [link](https://arxiv.org/pdf/2602.06025)
- [arXiv260206] Can vision language models learn intuitive physics from interaction? [link](https://arxiv.org/pdf/2602.06033)
- [arXiv260206] Variance Reduction Based Experience Replay for Policy Optimization [link](https://arxiv.org/pdf/2602.05379)

**cs.AI/cs.LG contains "accelerate" total: 16**
- [arXiv260206] DisCa: Accelerating Video Diffusion Transformers with Distillation-Compatible Learnable Feature Caching [link](https://arxiv.org/pdf/2602.05449)
- [arXiv260206] M$^2$-Miner: Multi-Agent Enhanced MCTS for Mobile GUI Agent Data Mining [link](https://arxiv.org/pdf/2602.05429)
- [arXiv260206] Euphonium: Steering Video Flow Matching via Process Reward Gradient Guided Stochastic Dynamics [link](https://arxiv.org/pdf/2602.04928)
- [arXiv260206] Late-to-Early Training: LET LLMs Learn Earlier, So Faster and Better [link](https://arxiv.org/pdf/2602.05393)
- [arXiv260206] Gradually Compacting Large Language Models for Reasoning Like a Boiling Frog [link](https://arxiv.org/pdf/2602.04919)
- [arXiv260206] TurboBoA: Faster and Exact Attention-aware Quantization without Backpropagation [link](https://arxiv.org/pdf/2602.04929)
- [arXiv260206] E-Globe: Scalable $ε$-Global Verification of Neural Networks via Tight Upper Bounds and Pattern-Aware Branching [link](https://arxiv.org/pdf/2602.05068)
- [arXiv260206] Autodiscover: A reinforcement learning recommendation system for the cold-start imbalance challenge in active learning, powered by graph-aware thompson sampling [link](https://arxiv.org/pdf/2602.05087)
- [arXiv260206] TIDE: Temporal Incremental Draft Engine for Self-Improving LLM Inference [link](https://arxiv.org/pdf/2602.05145)
- [arXiv260206] Accelerated Sequential Flow Matching: A Bayesian Filtering Perspective [link](https://arxiv.org/pdf/2602.05319)
- [arXiv260206] Variational Speculative Decoding: Rethinking Draft Training from Token Likelihood to Sequence Acceptance [link](https://arxiv.org/pdf/2602.05774)
- [arXiv260206] STProtein: predicting spatial protein expression from multi-omics data [link](https://arxiv.org/pdf/2602.05811)
- [arXiv260206] Characterizing Human Semantic Navigation in Concept Production as Trajectories in Embedding Space [link](https://arxiv.org/pdf/2602.05971)
- [arXiv260206] Multi-Token Prediction via Self-Distillation [link](https://arxiv.org/pdf/2602.06019)
- [arXiv260206] ARCHI-TTS: A flow-matching-based Text-to-Speech Model with Self-supervised Semantic Aligner and Accelerated Inference [link](https://arxiv.org/pdf/2602.05207)
- [arXiv260206] Variance Reduction Based Experience Replay for Policy Optimization [link](https://arxiv.org/pdf/2602.05379)
